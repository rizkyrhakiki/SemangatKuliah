                ...
                <div class="col-md-4 offset-md-4 mt-5 ">
                    <form method="POST" action="" aria-label="">
                        <div class="form-group">
                            <input type="text" id="name" name="name" class="form-control" value="" placeholder="Nama Lengkap" required autofocus>
                 
                                <small class="color-budayaku"></small>
                        </div>
                        <div class="form-group">
                            <input type="email" id="email" name="email" class="form-control" value="" placeholder="E-mail" required autofocus>
                        ...
                        <p>Dengan klik daftar, kamu telah menyetujui <strong><a href="#" class="color-brand">Aturan Penggunaan</a></strong>dan <strong><a href="#" class="color-brand">Kebijakan Privasi</a></strong> dari <span class="font-budayaku color-budayaku">Budayaku</span>.</p>
